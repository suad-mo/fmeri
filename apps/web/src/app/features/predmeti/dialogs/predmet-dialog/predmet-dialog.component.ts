...
import { IPredmet, Organ } from '../../../../core/models/org.models';
...
export class PredmetDialogComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (this.data.predmet) {
      ...
      this.form.patchValue({
        ...
        datumArhiviranja: p.datumArhiviranja ? new Date(p.datumArhiviranja) : null,
      });
    }
  }
  ...
  const data: Partial<IPredmet> = {
    ...
    organ:            raw.organ ? { _id: raw.organ } as any : undefined,
